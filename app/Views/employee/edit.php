                ...
                <form action="<?= base_url('employee/update/'.$employee['id'])?>" method="POST">
                 ...
                 <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="number" class="form-control" name="phone" value="<?= $employee['phone']?>" id="phone">
                  </div>
                  <div class="mb-3">
                    <label for="designation" class="form-label">Designation</label>
                    <input type="text" class="form-control" name="designation" value="<?= $employee['designation']?>" id="designation">
                  </div>
